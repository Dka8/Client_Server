...
Замечания по дальнейшему совершенствованию проекта:
	1.	Добавить кросплатформенность.
	2.	Использовать мультипоточность на стороне как сервера, так и клиента,
		для распаралеливания разных протокол связи и выделить отдельный поток для консольных комманд (exit и т.п.)
	3.	Функции обработки входящей строки на стороне сервера выделить в отдельный функционал.
	4. 	Разгрузить Client_main.cpp, написать отдельный класс, для работы со входящей
